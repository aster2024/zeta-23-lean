...
theorem small_endpointK_localizes_first_six
  ...
  · refine ⟨1, ?_⟩
    ...
    exact wider_positive_half_interval_localizes
      (i := (1 : Fin 5)) (by
        constructor <;> norm_num <;> nlinarith [h4pi, h5]) hsmall
  ...
  · refine ⟨2, ?_⟩
    ...
    exact wider_positive_half_interval_localizes
      (i := (2 : Fin 5)) (by
        constructor <;> norm_num <;> nlinarith [h6pi, h7]) hsmall
  ...
  · refine ⟨3, ?_⟩
    ...
    exact wider_positive_half_interval_localizes
      (i := (3 : Fin 5)) (by
        constructor <;> norm_num <;> nlinarith [h8pi, h9]) hsmall
  ...
  · refine ⟨4, ?_⟩
    ...
    exact wider_positive_half_interval_localizes
      (i := (4 : Fin 5)) (by
        constructor <;> norm_num <;> nlinarith [h10pi, h11]) hsmall
