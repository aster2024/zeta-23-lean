...
-/
import Zeta23.StrictImprovement.Q7FullSpectralZetaAtD
import Zeta23.StrictImprovement.Q7FullSpectralZetaSeamDefect

/-! # Concrete fixed-height seam for full-spectral q7 superbin packing -/
...
theorem seamA_mult2_atD_with_q7FullSpectral_gain
  ...
  have haD : 0 < (P.atD T).a T := by
    ...
    nlinarith
  apply seamA_mult2_with_q7FullSpectral_gain Z T (P.atD T)
    hconj hreal hPois hTl haD hLD hT.le hpos hscale
  intro q
  exact packedCoreQ7FullSpectralBlock_atD_traceNorm_lower
