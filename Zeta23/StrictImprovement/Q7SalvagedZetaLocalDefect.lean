...
import Zeta23.StrictImprovement.Q7SalvagedPacking
...
theorem hatAz_mult2_with_q7Salvaged_gain
  ...
  have hcover : ∑ b, (q7SalvagedLeftOccupancy E b +
      q7SalvagedRightOccupancy E b) =
      Fintype.card (CoreSimpleLabel Z T 3) := by
    dsimp [E]
    exact coreQ6HalfBinEnumeration_superbin_cover
      Z T 3 P hL (by norm_num)
  have hbins := coreQ7Salvaged_card_le T P hL hT
  ...
  have hmain := rank_trace_two_with_normalized_q6_selected_blocks
    ...
    q7SalvagedBlockReward (sum_q7SalvagedBlockReward_eq E)
