...
/-!
# Tail-stable seam with spectral four-point gain

This transports the finite-core spectral gain from `A_z` to the full matrix
`G_z`, retaining exactly the frozen multiplicity and tail-error terms.
-/
...
/-- The spectral four-point version of `Assembly.seamA_mult2`. -/
theorem seamA_mult2_with_spectral_core_gain
  ...
  have hcore := hatAz_mult2_with_spectral_core_gain
    Z T P hconj hreal hPois (by positivity) hL hT hpos hm hlocal
