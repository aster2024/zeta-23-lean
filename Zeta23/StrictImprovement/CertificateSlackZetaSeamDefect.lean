...
/-!
# Tail-stable seam with the full-certificate spectral gain
-/
...
/-- The full-certificate analogue of `Assembly.seamA_mult2`. -/
theorem seamA_mult2_with_certificate_slack_spectral_gain
  ...
  have hcore := hatAz_mult2_with_certificate_slack_spectral_gain
