...
-/
import Zeta23.StrictImprovement.Q6SuperbinZetaAtD
import Zeta23.StrictImprovement.Q6SuperbinZetaSeamDefect

/-! # Concrete fixed-height seam for q6 superbin packing -/
...
theorem seamA_mult2_atD_with_q6Superbin_gain
  ...
  have haD : 0 < (P.atD T).a T := by
    ...
    nlinarith
  apply seamA_mult2_with_q6Superbin_gain Z T (P.atD T)
    hconj hreal hPois hTl haD hLD hT.le hpos hscale
  intro q
  exact packedCoreQ6SuperbinBlock_atD_traceNorm_lower
    hcertificates Z hP hconj hreal hF hT hc hbudget hwL hpos
      hmargin3 hmargin4 hmargin5 hmargin6 q
