...
-/
import Zeta23.StrictImprovement.WideRepairZetaSeamAtD
import Zeta23.StrictImprovement.WideRepairZetaCoreGain
import Zeta23.StrictImprovement.ZetaLocalDeltaLimit

/-! # Eventual mixed repaired seam at fixed taper -/
...
theorem eventually_seamA_mult2_atD_with_wide_repair_gain
  ...
  filter_upwards [hTail, hNonempty, eventually_ge_atTop T0,
      ...
      haRange, hmargin3Ev, hmargin4Ev, hmargin5Ev,
      eventually_gt_atTop (0 : ℝ)]
    with T hTl hne hT0 h16 hlarge haD hm3 hm4 hm5 hT
  ...
  have hseam := seamA_mult2_atD_with_wide_repair_gain
    hcertificates Z hP hconj hreal hPois hF hTl hT hc hbudget h16 hpos
      hscale hm3.le hm4.le hm5.le
  simpa [wideRepairAtDCoreGain] using hseam
