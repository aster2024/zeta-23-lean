...
/-! # Mixed repaired local blocks at a fixed taper -/
...
theorem packedCoreWideRepairBlock_atD_traceNorm_lower
    ...
    (q : WideRepairBlock
      (coreWideRepairEnumeration Z T 3 (P.atD T)
  ...
  have heps : 0 ≤ 12 * P.w / P.L T + 3 * (1 - P.lam) := by
    ...
    nlinarith
  apply packedCoreWideRepairBlock_traceNorm_lower
    Z T (P.atD T) hconj hcertificates (ThmD.cDT P.ϱ P.lam)
